    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 p-5 md:p-6 flex flex-col justify-between">
                ...
                <div className="absolute md:bottom-6 md:left-65 z-10">
                    <a
                        ...
                        className="
                            ...
                            px-4 h-8
                            bg-[#C39E93] text-[12px] leading-none text-white
                            hover:bg-[#be745e] transition
...
export default NikeAdCardLittle
